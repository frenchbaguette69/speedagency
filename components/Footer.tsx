      ...
      <div className="max-w-7xl mx-auto text-sm text-neutral-500 flex sm:flex-row flex-col justify-between items-start  md:px-8">
        <div>
          ...
          <div className="mt-2 ml-2">
            &copy; copyright NextWebsite 2025. All rights reserved.
          </div>
        </div>
...
const Logo = () => {
  return (
    ...
    >
      <Image
        src="/nextwebsitelogo.png"
        alt="logo"
        width={30}
        height={30}
      />
      <span className="font-medium text-3xl text-black dark:text-white">Next Website</span>
    </Link>
  );
};
