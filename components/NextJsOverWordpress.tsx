...
import { FaBolt, FaShieldAlt, FaSearch, FaMobile, FaTools, FaChartLine, FaUsers, FaCreditCard } from "react-icons/fa";
...
export const NextJsOverWordPress = () => {
  ...
  return (
    <section className="py-20 overflow-hidden bg-gradient-to-br from-cyan-50 via-white to-cyan-50 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900">
      <div className="container mx-auto max-w-7xl px-5">
        ...
        >
          <h2 className="relative text-4xl md:text-5xl font-bold mb-6 inline-block">
            <span className="bg-gradient-to-r from-[#54eff6] to-[#4cfea6] bg-clip-text text-transparent">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <h3 className="text-2xl font-bold mb-6 text-zinc-800 dark:text-white">
                Voordelen van <span className="text-[#54eff6] dark:text-[#54eff6]">Next.js</span>
              </h3>
                ...
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className={`flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all ${
                      activeFeature === index 
                        ? `bg-gradient-to-r ${feature.color} text-zinc-800 shadow-md` 
                        : "bg-gray-50 dark:bg-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-600"
                    }`}
                  >
                    <div className={`p-3 rounded-full ${activeFeature === index ? 'bg-white/20' : 'bg-cyan-100 dark:bg-cyan-900/30'}`}>
                      {feature.icon}
                    </div>
                    <div>
                      <h4 className={`font-medium ${activeFeature === index ? 'text-zinc-800' : 'text-zinc-800 dark:text-white'}`}>
                        {feature.title}
                      </h4>
                    </div>
                  </motion.div>
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl overflow-hidden h-full">
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className={`p-4 rounded-full bg-gradient-to-br ${features[activeFeature].color} text-zinc-800`}>
                    ...
                    {[
                      ...
                      <div key={index} className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          {/* Next.js bar */}
                          <div className="space-y-1">
                            <div className="text-xs text-[#54eff6] dark:text-[#54eff6]">Next.js</div>
                            <div className="h-2 w-full bg-gray-200 dark:bg-zinc-600 rounded-full overflow-hidden">
                              <motion.div
                                initial={{ width: 0 }}
          ...
          {[
            {
              ...
              icon: <FaSearch className="text-zinc-800 text-2xl" />,
              color: "from-[#54eff6] to-[#4cfea6]"
            },
            {
              ...
              icon: <FaUsers className="text-zinc-800 text-2xl" />,
              color: "from-[#4cfea6] to-[#f9fa4c]"
            },
            {
              ...
              icon: <FaCreditCard className="text-zinc-800 text-2xl" />,
              color: "from-[#f9fa4c] to-[#54eff6]"
            }
          ].map((card, index) => (
            <motion.div
        ...
        >
          <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white">
            Klaar om uw website te upgraden van <span className="line-through text-red-500">WordPress</span> naar <span className="text-[#54eff6] dark:text-[#54eff6]">Next.js</span>?
          </h3>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="px-8 py-3 rounded-full bg-gradient-to-r from-[#54eff6] to-[#4cfea6] hover:from-[#4cfea6] hover:to-[#54eff6] text-zinc-800 font-medium shadow-lg transition-all"
          >
