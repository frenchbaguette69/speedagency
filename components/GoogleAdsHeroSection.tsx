...
import { FaAd, FaChartLine, FaRocket, FaPercentage, FaCheckCircle, FaArrowRight, FaMoneyBillWave, FaCogs } from "react-icons/fa";

export const GoogleAdsHeroSection = () => {
  ...
  const features = [
    {
      title: "Data-Gedreven Campagnes",
      description: "Google Ads gebaseerd op data, niet op vermoedens",
      icon: <FaChartLine className="text-2xl" />
    },
    {
      title: "Hogere Conversie Ratio",
      description: "Doelgerichte advertenties die converteren",
      icon: <FaPercentage className="text-2xl" />
    },
    {
      title: "Gericht Verkeer",
      description: "Alleen potentiële klanten binnenhalen",
      icon: <FaAd className="text-2xl" />
    },
    {
      title: "Optimale ROI",
      description: "Maximale resultaten uit je advertentiebudget",
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-gradient-to-b from-white via-purple-50/30 to-white dark:from-zinc-900 dark:via-purple-950/20 dark:to-zinc-900 pt-20 pb-24">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute bottom-20 right-10 w-96 h-96 bg-red-300/20 dark:bg-red-500/10 rounded-full blur-3xl"
        />
        ...
        <div className="absolute top-1/4 left-10">
          <motion.div
            ...
            className="w-6 h-6 bg-purple-500 rounded-full opacity-20"
          />
        </div>
        <div className="absolute bottom-1/3 right-20">
          <motion.div
            ...
            className="w-8 h-8 bg-red-500 rounded-full opacity-20"
          />
        </div>
        <div className="absolute top-1/2 left-1/4">
          <motion.div
            ...
            className="w-4 h-4 bg-pink-500 rounded-full opacity-20"
          />
        </div>
        ...
        <div className="absolute right-[10%] top-[15%] hidden lg:block">
          ...
          >
            <motion.div
              ...
              className="relative w-16 h-16 bg-gradient-to-br from-purple-600 to-red-600 rounded-full flex items-center justify-center shadow-lg"
            >
              ...
              <motion.div
                ...
                className="absolute inset-0 rounded-full bg-purple-400 -z-10 opacity-40 blur-sm"
              />
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-6 relative">
          ...
          <div className="lg:w-1/2 text-center lg:text-left pt-10 lg:pt-0">
            ...
            >
              <span className="bg-gradient-to-r from-purple-600 to-red-600 text-white text-xs uppercase font-bold py-1.5 px-3 rounded-full tracking-wider shadow-md">
            ...
            >
              ...
              >
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-red-600">Omzet Met Ads </span>
                <motion.span
                  animate={{ 
                    rotate: [0, 10, 0, -10, 0],
                  }}
            ...
            >
              Maximaliseer je rendement met onze data-gestuurde Google Ads campagnes. Wij zorgen voor gerichte advertenties die precies de juiste doelgroep bereiken en converteren naar betalende klanten.
            </motion.p>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="px-8 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-red-600 text-white font-medium shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 group"
              >
                <span>Gratis Ads Analyse</span>
                <motion.div
                  animate={{ x: [0, 5, 0] }}
                  transition={{ 
                    duration: 1,
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="px-8 py-4 rounded-xl border border-purple-200 dark:border-purple-800/50 hover:border-purple-300 dark:hover:border-purple-700 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm text-purple-600 dark:text-purple-400 font-medium shadow-md"
              >
                Bekijk Ads Cases
              </motion.button>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <span>75+ Campagnes Beheerd</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                <FaCheckCircle className="text-green-500" />
                <span>Gemiddeld 40% Lagere CPC</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                <FaCheckCircle className="text-green-500" />
                <span>Resultaten binnen 7-14 dagen</span>
              </div>
            </motion.div>
          </div>
                ...
                <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-zinc-700">
                  ...
                  <div className="bg-gray-100 dark:bg-zinc-700 p-3 flex items-center gap-2 border-b border-gray-200 dark:border-zinc-600">
                    ...
                    <div className="flex-1 flex justify-center">
                      <div className="bg-white dark:bg-zinc-600 rounded-lg px-4 py-1 text-xs text-zinc-500 dark:text-zinc-300 w-72 truncate">
                        https://ads.google.com/campagne-dashboard
                      </div>
                    </div>
                  </div>
                  
                  {/* Google Ads dashboard with loading effect */}
                  <div className="relative h-[450px] overflow-hidden">
                    ...
                    >
                      ...
                      >
                        <div className="text-sm font-medium mb-1">Campagne succes! 🎉</div>
                        <div className="text-xs text-purple-200">ROI verhoogd met 124%</div>
                      </motion.div>
                    </motion.div>
                    ...
                    >
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-purple-600 dark:text-purple-400">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-xs font-medium text-zinc-600 dark:text-zinc-400">Ads</div>
                    </div>
