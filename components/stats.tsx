...
import { IconServer, IconTimeline } from "@tabler/icons-react";
  ...
  const items = [
    {
      ...
      description: "Zolang zijn wij al bedrijven aan het helpen het internet te veroveren.",
      icon: IconTimeline,
      value: "8+ jaar ervaring",
    },
    {
      title: "People Served",
      description: "Al meer dan 107 klanten geholpen met hun online vindbaarheid.",
      icon: Monitor,
      value: "107+ Websites",
    },
    {
      title: "Response Time",
      description: "We hebben een prachtig bedrag omgezet voor onze klanten zowel SEA als SEO.",
      icon: Euro,
      value: "1.2m+ omzet",
    },
  ];
...
export const Grid = ({
  ...
  export function GridPattern({
    ...
    // Gebruik een deterministische ID
    const patternId = useMemo(() => `pattern-static-id`, []);
